public class Calculador {
	...
	/**
	 * Número de iterações que cada thread usará para calcular o PI. Quanto maior o
	 * número de iterações, mais precisão nas casas decimais é obtida
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		// armazena o tempo inicial de execução, para calcular depois quanto tempo o
		// programa levou
		// para executar
		...
		// faz com que a thread principal aguarde até que todas as threads tenham
		// terminado de executar
		for (int i = 0; i < threads.length; i++) {
			threads[i].join();
		}
